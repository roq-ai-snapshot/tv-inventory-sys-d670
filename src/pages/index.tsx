...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`TV inventory system`}</title>

        <meta
          name="description"
          content="Welcome to TV Inventory System - Streamlining Your Shop's Television Stock Management for Optimal Efficiency and Profitability."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1593784991095-a205069470b6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxUVnxlbnwwfHx8fDE2OTE3Mjk1ODh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@jonasleupe?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Jonas Leupe`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to TV Inventory System - Streamlining Your Shop's Television Stock Management for Optimal Efficiency and Profitability.`}
            </Text>
            <Box
